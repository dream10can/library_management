...
import 'package:library_management/screens/update_student_records.dart';
...
class _LandingPageState extends State<LandingPage> {
  ...
  void initState() {
    ...
    allCourses = checkStudDp.studList;
                            ...
                            child: Column(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    final studDelete =
                                        context.read(studDeleteData);

                                    studDelete.deleteCourse(stud.id);

                                    final getAllStud =
                                        context.read(studListData);

                                    getAllStud.allCourses();
                                  },
                                  child: Icon(
                                    Icons.delete,
                                    color: Colors.red,
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) {
                                          return UpdateStudentRecord(stud);
                                        },
                                      ),
                                    );
                                  },
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        textSpanDesign('ISBN', FontWeight.w900,
                                            Colors.white),
                                        textSpanNormal(
                                        ...
                                        textSpanDesign('Description',
                                            FontWeight.w900, Colors.white),
                                        textSpanNormal(
                                            stud.description, Colors.grey[200]),
                                      ],
                                    ),
                                  ),
                                ),
